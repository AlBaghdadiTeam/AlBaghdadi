...
else redis:set(AlBaghdadi.."lock_RandomRdod"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_RandomRdod"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل الردود العشوائيه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:del(AlBaghdadi.."lock_RandomRdod"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_KickBan"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل الحظر والطرد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(AlBaghdadi.."lock_KickBan"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_KickBan"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل الحظر والطرد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:del(AlBaghdadi.."lock_KickBan"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_rdodSource"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل ردود السورس    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(AlBaghdadi.."lock_rdodSource"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_rdodSource"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل  ردود السورس    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:del(AlBaghdadi.."lock_rdodSource"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_check"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تعطيل التحقق    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )        else 
redis:del(AlBaghdadi.."lock_check"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_check"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تفعيل التحقق    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )        else
redis:set(AlBaghdadi.."lock_check"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_cleaner"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تعطيل التنظيف التلقائي    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else 

redis:del(AlBaghdadi.."lock_cleaner"..msg.chat_id_)
local Cleaner = redis:smembers(AlBaghdadi..":IdsMsgsCleaner:"..msg.chat_id_)
for k,v in pairs(Cleaner) do
redis:del(AlBaghdadi..":SetTimerCleaner:"..msg.chat_id_..v) 
Del_msg(msg.chat_id_,v)
end
redis:del(AlBaghdadi..":IdsMsgsCleaner:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_cleaner"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تفعيل التنظيف التلقائي    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )        else
redis:set(AlBaghdadi.."lock_cleaner"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_takkl"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل تاك للكل    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(AlBaghdadi.."lock_takkl"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_takkl"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل تاك للكل    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(AlBaghdadi.."lock_takkl"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_leftgroup"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل المغادره    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(AlBaghdadi.."lock_leftgroup"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_leftgroup"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل المغادره    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(AlBaghdadi.."lock_leftgroup"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."antiedit"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تفعيل الحمايه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(AlBaghdadi.."antiedit"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."antiedit"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تعطيل الحمايه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(AlBaghdadi.."antiedit"..msg.chat_id_) 
...
else redis:set(AlBaghdadi.."idphoto"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."idphoto"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل الايدي بالصوره    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(AlBaghdadi.."idphoto"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_linkk"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل الرابط    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(AlBaghdadi.."lock_linkk"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_linkk"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل الرابط    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(AlBaghdadi.."lock_linkk"..msg.chat_id_) 
...
else redis:set(AlBaghdadi.."lock_woring"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_woring"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تعطيل التحذير    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(AlBaghdadi.."lock_woring"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_id"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل الايدي    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(AlBaghdadi.."lock_id"..msg.chat_id_) 
...
redis:set(AlBaghdadi.."lock_id"..msg.chat_id_,true)  
...
else redis:set(AlBaghdadi.."welcome:get"..msg.chat_id_,true)  
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."welcome:get"..msg.chat_id_) then 
...
local NameUser   = Hyper_Link_Name(data)
redis:mset(
AlBaghdadi.."lock_username"..msg.chat_id_,true,
AlBaghdadi.."mute_gif"..msg.chat_id_,true,
AlBaghdadi.."mute_photo"..msg.chat_id_,true,
AlBaghdadi.."mute_audio"..msg.chat_id_,true,
AlBaghdadi.."mute_voice"..msg.chat_id_,true,
AlBaghdadi.."mute_sticker"..msg.chat_id_,true,
AlBaghdadi.."mute_forward"..msg.chat_id_,true,
AlBaghdadi.."mute_contact"..msg.chat_id_,true,
AlBaghdadi.."mute_location"..msg.chat_id_,true,
AlBaghdadi.."mute_document"..msg.chat_id_,true,
AlBaghdadi.."lock_link"..msg.chat_id_,true,
AlBaghdadi.."lock_tag"..msg.chat_id_,true,
AlBaghdadi.."lock_edit"..msg.chat_id_,true,
AlBaghdadi.."lock_spam"..msg.chat_id_,true,
AlBaghdadi.."lock_bots"..msg.chat_id_,true,
AlBaghdadi.."lock_webpage"..msg.chat_id_,true,
AlBaghdadi.."mute_video"..msg.chat_id_,true,
AlBaghdadi.."mute_inline"..msg.chat_id_,true
)
...
local NameUser   = Hyper_Link_Name(data)
redis:del(
AlBaghdadi.."lock_username"..msg.chat_id_,
AlBaghdadi.."mute_gif"..msg.chat_id_,
AlBaghdadi.."mute_photo"..msg.chat_id_,
AlBaghdadi.."mute_audio"..msg.chat_id_,
AlBaghdadi.."mute_voice"..msg.chat_id_,
AlBaghdadi.."mute_sticker"..msg.chat_id_,
AlBaghdadi.."mute_forward"..msg.chat_id_,
AlBaghdadi.."mute_contact"..msg.chat_id_,
AlBaghdadi.."mute_location"..msg.chat_id_,
AlBaghdadi.."mute_document"..msg.chat_id_,
AlBaghdadi.."lock_link"..msg.chat_id_,
AlBaghdadi.."lock_tag"..msg.chat_id_,
AlBaghdadi.."lock_edit"..msg.chat_id_,
AlBaghdadi.."lock_spam"..msg.chat_id_,
AlBaghdadi.."lock_bots"..msg.chat_id_,
AlBaghdadi.."lock_webpage"..msg.chat_id_,
AlBaghdadi.."mute_video"..msg.chat_id_,
AlBaghdadi..":tqeed_video:"..msg.chat_id_,
AlBaghdadi..":tqeed_photo:"..msg.chat_id_,
AlBaghdadi..":tqeed_gif:"..msg.chat_id_,
AlBaghdadi..":tqeed_fwd:"..msg.chat_id_,
AlBaghdadi..":tqeed_link:"..msg.chat_id_,
AlBaghdadi.."mute_inline"..msg.chat_id_
)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi..":tqeed_video:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الفيديو بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(AlBaghdadi..":tqeed_video:"..msg.chat_id_)
redis:set(AlBaghdadi..":tqeed_video:"..msg.chat_id_,true)
...
local NameUser   = Hyper_Link_Name(data)
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if not redis:get(AlBaghdadi..":tqeed_video:"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi..":tqeed_gif:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل المتحركه بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(AlBaghdadi.."mute_gif"..msg.chat_id_)
redis:set(AlBaghdadi..":tqeed_gif:"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi..":tqeed_gif:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح المتحركه بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else 
redis:del(AlBaghdadi..":tqeed_gif:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi..":tqeed_fwd:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التوجيه بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(AlBaghdadi.."mute_forward"..msg.chat_id_)
redis:set(AlBaghdadi..":tqeed_fwd:"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi..":tqeed_fwd:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح التوجيه  بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else 
redis:del(AlBaghdadi..":tqeed_fwd:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi..":tqeed_link:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الروابط بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:set(AlBaghdadi..":tqeed_link:"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi..":tqeed_link:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الروابط بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else 
redis:del(AlBaghdadi..":tqeed_link:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi..":tqeed_photo:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الصور بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:set(AlBaghdadi..":tqeed_photo:"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi..":tqeed_photo:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الصور بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else 
redis:del(AlBaghdadi..":tqeed_photo:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_twasel") then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل التواصل    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:set(AlBaghdadi.."lock_twasel",true)
...
redis:del(AlBaghdadi.."lock_twasel")
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lockidedit") then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل تعيين الايدي للمطور    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else redis:set(AlBaghdadi.."lockidedit",true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lockidedit") then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل تعيين الايدي للمطور    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(AlBaghdadi.."lockidedit") 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_brod") then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل اذاعه المطورين    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(AlBaghdadi.."lock_brod")
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_brod") then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل اذاعه المطورين    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else 
redis:set(AlBaghdadi.."lock_brod",true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."replay"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل الردود    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(AlBaghdadi.."replay"..msg.chat_id_)
...
redis:set(AlBaghdadi.."replay"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_service") then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل نظام البوت خدمي    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(AlBaghdadi.."lock_service")
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_service") then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل نظام البوت خدمي    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:set(AlBaghdadi.."lock_service",true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_mmno3"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الفشار    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."lock_mmno3"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_mmno3"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الفشار    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."lock_mmno3"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_pharsi"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الفارسيه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."lock_pharsi"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_pharsi"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الفارسيه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."lock_pharsi"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_lang"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الانكليزيه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."lock_lang"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_lang"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الانكليزيه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."lock_lang"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_link"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الروابط    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."lock_link"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_link"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الروابط    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."lock_link"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_Add"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الاضافه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."lock_Add"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_Add"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الاضافه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."lock_Add"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_tag"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التاك (#)    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."lock_tag"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_tag"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح التاك (#)    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."lock_tag"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_username"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل المعرفات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."lock_username"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_username"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح المعرفات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."lock_username"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_edit"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التعديل    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."lock_edit"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_edit"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح التعديل    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."lock_edit"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if   redis:get(AlBaghdadi.."lock_spam"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الكلايش    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."lock_spam"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_spam"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الكلايش    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."lock_spam"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_flood"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التكرار    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."lock_flood"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_flood"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح التكرار    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."lock_flood"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_bots"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل البوتات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."lock_bots"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_bots"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح البوتات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."lock_bots_by_kick"..msg.chat_id_)
redis:del(AlBaghdadi.."lock_bots"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_join"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الاضافه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."lock_join"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم قفل الاضافه بنجاح   \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_join"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الاضافه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."lock_join"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم فتح الاضافه بنجاح   \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_markdown"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الماركدوان    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."lock_markdown"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_markdown"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الماركدوان    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."lock_markdown"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_webpage"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الويب    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."lock_webpage"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_webpage"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الويب    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."lock_webpage"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."mute_gif"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل المتحركه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."mute_gif"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."mute_gif"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."mute_game"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."mute_game"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الالعاب    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."mute_game"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."mute_inline"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الانلاين    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."mute_inline"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."mute_inline"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الانلاين    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."mute_inline"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."mute_text"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الدردشه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."mute_text"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."mute_text"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الدردشه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."mute_text"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."mute_photo"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الصور    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."mute_photo"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."mute_photo"..msg.chat_id_)then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الصور    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."mute_photo"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."mute_video"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الفيديو    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."mute_video"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."mute_video"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الفيديو    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."mute_video"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."mute_audio"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الصوت    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."mute_audio"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."mute_audio"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الصوت    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."mute_audio"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."mute_voice"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل البصمات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."mute_voice"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."mute_voice"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح البصمات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."mute_voice"..msg.chat_id_)
...
if   redis:get(AlBaghdadi.."mute_sticker"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الملصقات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."mute_sticker"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."mute_sticker"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الملصقات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."mute_sticker"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."mute_contact"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الجهات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."mute_contact"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."mute_contact"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الجهات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."mute_contact"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."mute_forward"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التوجيه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."mute_forward"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."mute_forward"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."mute_location"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الموقع    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."mute_location"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."mute_location"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الموقع    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."mute_location"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."mute_document"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الملفات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."mute_document"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."mute_document"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الملفات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."mute_document"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."mute_tgservice"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الاشعارات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."mute_tgservice"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."mute_tgservice"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الاشعارات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."mute_tgservice"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."mute_keyboard"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الكيبورد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."mute_keyboard"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."mute_keyboard"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الكيبورد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."mute_keyboard"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_bots_by_kick"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل البوتات بالطرد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."lock_bots"..msg.chat_id_,true)
redis:set(AlBaghdadi.."lock_bots_by_kick"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_bots_by_kick"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(AlBaghdadi.."lock_pin"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التثبيت    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(AlBaghdadi.."lock_pin"..msg.chat_id_,true) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(AlBaghdadi.."lock_pin"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح التثبيت    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(AlBaghdadi.."lock_pin"..msg.chat_id_)
