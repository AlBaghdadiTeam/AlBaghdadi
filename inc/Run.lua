...
if SUDO_USER ~= '' then
print('\n\27[1;31mتم ادخال المعرف')
create_config(Token)
redis:set("SUDO_USER",SUDO_USER)
end 
io.write('\n\27[1;33mادخل ايدي المطور الاساسي: \27[0;39;49m')
SUDO_Id = io.read():gsub(' ','')
if SUDO_Id ~= '' then
print('\n\27[1;31mتم ادخال ايدي المطور')
create_config(Token)
redis:set("SUDO_Id",SUDO_Id)
end 
...
AlBaghdadi = Token:match("(%d+)")
redis:mset(
AlBaghdadi..":VERSION",GetUser.information.Source_version,
AlBaghdadi..":SUDO_ID:",GetUser.information.id,
AlBaghdadi..":DataCenter:",GetUser.information.DataCenter,
AlBaghdadi..":UserNameBot:",BOT_User,
AlBaghdadi..":ApiSource",GetUser.information.WebSite,
AlBaghdadi..":NameBot:","البغدادي",
"TH3AlBaghdadi_INSTALL","Yes")
h = redis:get("SUDO_USER",SUDO_USER)
s = redis:get("SUDO_Id",SUDO_Id)
redis:hset(AlBaghdadi..'username:'..s,'username','@'..h('_',[[\_]]))
Cr_file = io.open("./inc/Token.txt", "w")
Cr_file:write(Token)
Cr_file:close()
print('\27[1;36m￤Token.txt is created.\27[m')
local Text = "🙋🏼‍♂️¦ اهلا عزيزي [المطور الاساسي](tg://user?id="..s..") \n🔖¦ شكرا لاستخدامك سورس البغدادي \n📡¦ أرســل  الان /start\n📛¦ لاضهار الاوامر للمطور  المجهزه بالكيبورد\n\n⚡️"
https.request(Api_Token..'/sendMessage?chat_id='..s..'&text='..URL.escape(Text)..'&parse_mode=Markdown')
local CmdRun = [[
rm -f ./README.md
rm -rf ./.git
chmod +x ./run
cp -a ../AlBaghdadi ../]]..BOT_User..[[ &&
rm -fr ~/AlBaghdadi
../]]..BOT_User..[[/run
]]
print(CmdRun)
os.execute(CmdRun)
redis:del("SUDO_USER",SUDO_USER)
redis:del("SUDO_Id",SUDO_Id)
end
...
AlBaghdadi = Token:match("(%d+)")
our_id = tonumber(AlBaghdadi)
ApiAlBaghdadi = redis:get(AlBaghdadi..":ApiSource")
ApiToken = "https://api.telegram.org/bot"..Token
Bot_User = redis:get(AlBaghdadi..":UserNameBot:")
SUDO_ID = tonumber(redis:get(AlBaghdadi..":SUDO_ID:"))
if not SUDO_ID then io.popen("rm -fr ./inc/Token.txt") end
SUDO_USER = redis:hgetall(AlBaghdadi..'username:'..SUDO_ID).username
version = redis:get(AlBaghdadi..":VERSION")
DataCenter = redis:get(AlBaghdadi..":DataCenter:")
...
print('\27[0;33m>>'..[[■]]..'\027[0;32m'
..'¦ TOKEN_BOT: \27[1;34m'..Token..'\027[0;32m\n'
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..AlBaghdadi..')\027[0;32m\n'
..'¦ Run_Scrpt: \27[1;34m./inc/Script.lua\027[0;32m \n'
..'¦ LOGIN__IN: \27[1;34m'..login..'\027[0;32m \n'
..'¦ Api_Src->: \27[1;34m'..ApiAlBaghdadi..'\027[0;32m\n'
...
if not redis:get(AlBaghdadi..":Check_Bot:"..W) then
Rgz,res=https.request(ApiAlBaghdadi..Tkml..W)
if res == 200 and Rgz == "SendMsg" then redis:setex(AlBaghdadi..":Check_Bot:"..W,1800,true) return false else return Rgz end 
end 
end
...
if msg.type == "pv" and redis:get(AlBaghdadi..':mute_pv:'..msg.sender_user_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end
if msg.type ~= "pv" and redis:get(AlBaghdadi..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood') then
print("\27[1;31mThis Flood Sender ...\27[0")
Del_msg(msg.chat_id_,msg.id_)
return false
end
if redis:get(AlBaghdadi..'group:add'..msg.chat_id_) then 
...
and redis:get(AlBaghdadi.."lock_cleaner"..msg.chat_id_) then
print("Clener >>> ")
redis:sadd(AlBaghdadi..":IdsMsgsCleaner:"..msg.chat_id_,msg.id_)
Timerr = redis:get(AlBaghdadi..':Timer_Cleaner:'..msg.chat_id_)
if Timerr then 
Timerr = tonumber(Timerr)
Timerr = 60*60*Timerr
end
redis:setex(AlBaghdadi..":SetTimerCleaner:"..msg.chat_id_..msg.id_,Timerr or 21600,true)  
end
...
if not redis:get(AlBaghdadi..":SetTimerCleaner:"..msg.chat_id_..v) then
Del_msg(msg.chat_id_,v)
redis:srem(AlBaghdadi..":IdsMsgsCleaner:"..msg.chat_id_,v)
...
if msg.GroupActive and redis:get(AlBaghdadi..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
end
return false 
end 

if msg.sender_user_id_ == 60809019 or msg.sender_user_id_ == 665877797  then 
msg.TheRankCmd = 'مطور السورس'
msg.TheRank = 'مطور السورس'
msg.Rank = 1
elseif msg.sender_user_id_ == SUDO_ID then 
msg.TheRankCmd = redis:get(AlBaghdadi..":RtbaNew1:"..msg.chat_id_) or 'المطور الاساسي' 
msg.TheRank = redis:get(AlBaghdadi..":RtbaNew1:"..msg.chat_id_) or 'مطور اساسي 👨🏻‍✈️' 
msg.Rank = 1
elseif redis:sismember(AlBaghdadi..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(AlBaghdadi..":RtbaNew2:"..msg.chat_id_) or 'المطور'
msg.TheRank = redis:get(AlBaghdadi..":RtbaNew2:"..msg.chat_id_) or 'مطور البوت 👨🏽‍💻'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(AlBaghdadi..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(AlBaghdadi..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي'
msg.TheRank = redis:get(AlBaghdadi..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي 👲🏼'
msg.Rank = 11
elseif msg.GroupActive and redis:sismember(AlBaghdadi..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(AlBaghdadi..":RtbaNew4:"..msg.chat_id_) or 'المنشىء'
msg.TheRank = redis:get(AlBaghdadi..":RtbaNew4:"..msg.chat_id_) or 'المنشىء 👷🏽'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(AlBaghdadi..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(AlBaghdadi..":RtbaNew5:"..msg.chat_id_) or 'المدير' 
msg.TheRank = redis:get(AlBaghdadi..":RtbaNew5:"..msg.chat_id_) or 'مدير البوت 👨🏼‍⚕️' 
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(AlBaghdadi..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(AlBaghdadi..":RtbaNew6:"..msg.chat_id_) or 'الادمن'
msg.TheRank = redis:get(AlBaghdadi..":RtbaNew6:"..msg.chat_id_) or 'ادمن في البوت 👨🏼‍🎓'
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(AlBaghdadi..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRank = redis:get(AlBaghdadi..":RtbaNew7:"..msg.chat_id_) or 'عضو مميز'
msg.Rank = 6
...
local lock_bots = redis:get(AlBaghdadi..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(AlBaghdadi..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(AlBaghdadi..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(AlBaghdadi..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(AlBaghdadi..':WELCOME_BOT'),[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(AlBaghdadi..':NameBot:')..[[ 🎖
...
if not msg.Special and not msg.Admin and redis:get(AlBaghdadi.."lock_Add"..msg.chat_id_) then
...
if redis:get(AlBaghdadi.."lock_check"..msg.chat_id_) and not redis:get(AlBaghdadi..":TqeedUser:"..msg.chat_id_..Senderid) then
...
if msg.Special or msg.Admin then redis:srem(AlBaghdadi..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return false end
...
if msg.Special then redis:srem(AlBaghdadi..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(AlBaghdadi..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
if ScriptFile and ScriptFile.AlBaghdadi then 
if msg.text and ScriptFile.iAlBaghdadi then
XAlBaghdadi = ScriptFile.AlBaghdadi
local list = redis:hgetall(AlBaghdadi..":AwamerBotArray:"..msg.chat_id_)
for AlBaghdadi2,k in pairs(list) do
Text = msg.text
Text2 = k
if Text:match(AlBaghdadi2) then 
local amrr = {Text:match(AlBaghdadi2)}
local AmrOld = redis:hgetall(AlBaghdadi..":AwamerBotArray2:"..msg.chat_id_)
amrnew = "" amrold = ""
...
GetMsg = ScriptFile.iAlBaghdadi(msg,{Text:match(Text2)})
if GetMsg then
...
Text = Text:gsub("ک","ك")
Text = Text:gsub("ه‍","ه")
if Text:match(AlBaghdadi) then -- Check Commands To admin
AF = CheckBotA(msg) if AF then return sendMsg(msg.chat_id_,msg.id_,AF) end 
GetMsg = ScriptFile.iAlBaghdadi(msg,{Text:match(AlBaghdadi)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",AlBaghdadi.." | Plugin is: \27[1;32mScript.lua\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
return false
end 
end
...
if ScriptFile.dAlBaghdadi then
if ScriptFile.dAlBaghdadi(msg) == false then
return false
end
...
if Plug.AlBaghdadi then 
if msg.text and Plug.iAlBaghdadi then
for k, AlBaghdadi in pairs(Plug.AlBaghdadi) do
if msg.text:match(AlBaghdadi) then
local GetMsg = Plug.iAlBaghdadi(msg,{msg.text:match(AlBaghdadi)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",AlBaghdadi.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
if Plug.dAlBaghdadi then
Plug.dAlBaghdadi(msg)
print("\27[1;35m¦Msg_IN_Process : \27[1;32"..name.."\27[0m")
end
else
print("The File "..name.." Not Runing in The Source AlBaghdadi")
end 

end
else
print("The File Script.lua Not Runing in The Source AlBaghdadi")
end
end
...
redis:srem(AlBaghdadi..'users',msg.sender_user_id_)
end
...
if redis:get(AlBaghdadi..":propin"..msg.chat_id_) == msg.content_.text_ then
redis:del(AlBaghdadi..":propin"..msg.chat_id_)
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="تحديث ♻️") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 60809019 or msg.sender_user_id_ == 665877797) then
return sendMsg(msg.chat_id_,msg.id_,"🗂¦ تم تحديث الملفات",function(arg,data)
Refresh_Start = true
end)
end 
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 60809019 or msg.sender_user_id_ == 665877797) then
UpdateSource(msg)
...
if (msg.text == 'reload' or msg.text == "أعادة التشغيل 🔌") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 60809019 or msg.sender_user_id_ == 665877797) then
...
if redis:get(AlBaghdadi..'group:add'..data.chat_.id_) then
redis:set(AlBaghdadi..'group:name'..data.chat_.id_,data.chat_.title_)
end
elseif data.ID == "UpdateChannel" then  
if data.channel_.status_.ID == "ChatMemberStatusKicked" then 
if redis:get(AlBaghdadi..'group:add-100'..data.channel_.id_) then
local linkGroup = (redis:get(AlBaghdadi..'linkGroup-100'..data.channel_.id_) or "")
local NameGroup = (redis:get(AlBaghdadi..'group:name-100'..data.channel_.id_) or "")
...
redis:mset(
AlBaghdadi..'group:name'..k,IDS.Title,
AlBaghdadi..'num_msg_max'..k,5,
AlBaghdadi..'group:add'..k,true,
AlBaghdadi..'lock_link'..k,true,
AlBaghdadi..'lock_spam'..k,true,
AlBaghdadi..'lock_webpage'..k,true,
AlBaghdadi..'lock_markdown'..k,true,
AlBaghdadi..'lock_flood'..k,true,
AlBaghdadi..'lock_bots'..k,true,
AlBaghdadi..'mute_forward'..k,true,
AlBaghdadi..'mute_contact'..k,true,
AlBaghdadi..'mute_document'..k,true,
AlBaghdadi..'mute_inline'..k,true,
AlBaghdadi..'lock_username'..k,true,
AlBaghdadi..'replay'..k,true
)
redis:sadd(AlBaghdadi..'group:ids',k) 

if IDS.Admins then
for user,ID in pairs(IDS.Admins) do
redis:hset(AlBaghdadi..'username:'..ID,'username',user)
redis:sadd(AlBaghdadi..'admins:'..k,ID)
end
end
if IDS.Creator then
for user,ID in pairs(IDS.Creator) do
redis:hset(AlBaghdadi..'username:'..ID,'username',user)
redis:sadd(AlBaghdadi..':MONSHA_BOT:'..k,ID)
end
end
if IDS.Owner then
for user,ID in pairs(IDS.Owner) do
redis:hset(AlBaghdadi..'username:'..ID,'username',user)
redis:sadd(AlBaghdadi..'owners:'..k,ID)
end
end
end
io.popen("rm -fr ../.telegram-cli/data/document/*")
sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'📦*¦* تم رفع آلنسـخهہ‏‏ آلآحتيآطـيهہ\n⚖️*¦* حآليآ عدد مـجمـوعآتگ هہ‏‏يهہ‏‏ *'..redis:scard(AlBaghdadi..'group:ids')..'* 🌿\n✓')
end
elseif data.ID == "UpdateUser" then  
if data.user_.type_.ID == "UserTypeDeleted" then
print("¦ userTypeDeleted")
redis:srem(AlBaghdadi..'users',data.user_.id_)
elseif data.user_.type_.ID == "UserTypeGeneral" then
local CheckUser = redis:hgetall(AlBaghdadi..'username:'..data.user_.id_).username
...
redis:hset(AlBaghdadi..'username:'..data.user_.id_,'username',USERNAME)
end 
end
