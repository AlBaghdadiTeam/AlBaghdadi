...
download_file('https://raw.githubusercontent.com/AlBaghdadiTeam/AlBaghdadi/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/AlBaghdadiTeam/AlBaghdadi/main/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/AlBaghdadiTeam/AlBaghdadi/main/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/AlBaghdadiTeam/AlBaghdadi/main/inc/functions.lua','./inc/functions.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'100% - |█████████████|\n\n🔝*¦* تم تحديث السورس الى اصدار *v'..redis:get(AlBaghdadi..":VERSION")..'*\n📟*¦* تم اعاده تشغيل السورس بنجاح') end
if edit then dofile("./inc/Run.lua") end
print("Update Source And Reload ~ ./inc/Run.lua")

end
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(AlBaghdadi..":NameBot:") or "البغدادي"
...
usernn = data.username_ or "AlBaghdadi"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "AlBaghdadi"
end
Name = Name:gsub('[[][]]','')
...
local Fshar_Word , res = https.request('https://alsh-bg.ml/api/Words_Fshars.txt')
...
Fshar_Word , res = https.request('https://alsh-bg.ml/api/Words_Fshars.txt')
if res ~= 200 then Fshar_Word = "\n" end
...
var = 'هذا البوت 🙄☝🏿' 
elseif UserID == 961743188 or UserID == 665877797  then 
var = 'مطور السورس'
elseif  UserID == SUDO_ID then
var = redis:get(AlBaghdadi..":RtbaNew1:"..ChatID) or 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(AlBaghdadi..':SUDO_BOT:',UserID) then
var = redis:get(AlBaghdadi..":RtbaNew2:"..ChatID) or 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(AlBaghdadi..':MONSHA_Group:'..ChatID,UserID) then
var = redis:get(AlBaghdadi..":RtbaNew3:"..ChatID) or ' المنشىء اساسي👷🏽' 
elseif redis:sismember(AlBaghdadi..':MONSHA_BOT:'..ChatID,UserID) then
var = redis:get(AlBaghdadi..":RtbaNew4:"..ChatID) or ' المنشىء 👷🏽' 
elseif redis:sismember(AlBaghdadi..'owners:'..ChatID,UserID) then
var = redis:get(AlBaghdadi..":RtbaNew5:"..ChatID) or 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(AlBaghdadi..'admins:'..ChatID,UserID) then
var = redis:get(AlBaghdadi..":RtbaNew6:"..ChatID) or 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(AlBaghdadi..'whitelist:'..ChatID,UserID) then
var = redis:get(AlBaghdadi..":RtbaNew7:"..ChatID) or 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
return var
...
Replay = Replay:gsub("{البوت}",redis:get(AlBaghdadi..':NameBot:'))
...
if msg.edited then
redis:incr(AlBaghdadi..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info_ then
redis:incr(AlBaghdadi..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.content_.ID == "MessageChatAddMembers" then 
redis:incr(AlBaghdadi..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessagePhoto" then
redis:incr(AlBaghdadi..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageSticker" then
redis:incr(AlBaghdadi..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVoice" then
redis:incr(AlBaghdadi..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAudio" then
redis:incr(AlBaghdadi..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVideo" then
redis:incr(AlBaghdadi..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAnimation" then
redis:incr(AlBaghdadi..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local monshaas = redis:smembers(AlBaghdadi..':MONSHA_Group:'..msg.chat_id_)
local monsha = redis:smembers(AlBaghdadi..':MONSHA_BOT:'..msg.chat_id_)
local Owners = redis:smembers(AlBaghdadi..'owners:'..msg.chat_id_)
local Admins = redis:smembers(AlBaghdadi..'admins:'..msg.chat_id_)
local mmez = redis:smembers(AlBaghdadi..'whitelist:'..msg.chat_id_)
...
message = message ..i.. '-l ['..info.username..'](t.me/AlBaghdadi) \n'
end
...
local list = redis:smembers(AlBaghdadi..':SUDO_BOT:')
message = '👨🏽‍💻*¦* قائمه الـمـطـوريـن : \n\n`★`*_* ['..SUDO_USER..'] ➣ (' ..SUDO_ID.. '){'..redis:scard(AlBaghdadi..'mtwr_count'..SUDO_ID)..'}\n*----------------------------------*\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info  = redis:hgetall(AlBaghdadi..'username:'..v)
local count = redis:scard(AlBaghdadi..'mtwr_count'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.."-l ["..info.username..'] » (`' ..v.. '`){'..count..'} \n'
else
message = message ..k.. '-l ['..info.username..'](t.me/AlBaghdadi) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/AlBaghdadi) l » (`' ..v.. '`) \n'
end
end
end
...
local list = redis:smembers(AlBaghdadi..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(AlBaghdadi..'admins:'..msg.chat_id_)
...
local list = redis:smembers(AlBaghdadi..'whitelist:'..msg.chat_id_)
...
if redis:sismember(AlBaghdadi..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(AlBaghdadi..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(AlBaghdadi..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(AlBaghdadi..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(AlBaghdadi..'gban_users')
...
local list = redis:smembers(AlBaghdadi..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(AlBaghdadi..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*¦* الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(AlBaghdadi..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(AlBaghdadi..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(AlBaghdadi..':Filter_Word:'..msg.chat_id_,word) 
...
local NumberFlood = tonumber(redis:get(AlBaghdadi..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= 5 then 
result = false
else
redis:setex(AlBaghdadi..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
json_data = '{"BotID": '..AlBaghdadi..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(AlBaghdadi..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(AlBaghdadi..'group:name'..GroupS) or '')
...
local admins = redis:smembers(AlBaghdadi..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(AlBaghdadi..'username:'..value)
if info then 
...
local creator = redis:smembers(AlBaghdadi..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(AlBaghdadi..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(AlBaghdadi..'group:ids')
message = '📋*¦* قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(AlBaghdadi..'group:name'..v)
if info then 
...
redis:del(
AlBaghdadi..'group:add'..id_group,
AlBaghdadi..'lock_link'..id_group, 
AlBaghdadi..'lock_id'..id_group,
AlBaghdadi..'lock_spam'..id_group, 
AlBaghdadi..'lock_webpage'..id_group,
AlBaghdadi..'lock_markdown'..id_group,
AlBaghdadi..'lock_flood'..id_group,
AlBaghdadi..'lock_bots'..id_group,
AlBaghdadi..'mute_forward'..id_group,
AlBaghdadi..'mute_contact'..id_group,
AlBaghdadi..'mute_location'..id_group,
AlBaghdadi..'mute_document'..id_group,
AlBaghdadi..'mute_keyboard'..id_group,
AlBaghdadi..'mute_game'..id_group,
AlBaghdadi..'mute_inline'..id_group,
AlBaghdadi..'lock_username'..id_group,
AlBaghdadi..'num_msg_max'..id_group,
AlBaghdadi..'mute_text'..id_group,
AlBaghdadi..'admins:'..id_group,
AlBaghdadi..':Filter_Word:'..id_group,
AlBaghdadi..'banned:'..id_group,
AlBaghdadi..'is_silent_users:'..id_group,
AlBaghdadi..'whitelist:'..id_group,
AlBaghdadi..':MONSHA_BOT:'..id_group,
AlBaghdadi..'owners:'..id_group,
AlBaghdadi..'replay'..id_group,
AlBaghdadi..':MONSHA_Group:'..id_group
)
redis:srem(AlBaghdadi..'group:ids',id_group)
end
...
NumAdmin = NumAdmin + 1
if not redis:sismember(AlBaghdadi..'admins:'..arg.chat_id_,v.user_id_) then
GetUserID(v.user_id_,function(arg,data)
redis:hset(AlBaghdadi..'username:'..data.id_,'username',ResolveUserName(data))
redis:sadd(AlBaghdadi..'admins:'..arg.chat_id_,data.id_)
...
if redis:get(AlBaghdadi..'group:add'..msg.chat_id_) then  return sendMsg(msg.chat_id_,msg.id_,'📬¦ المجموعه بالتأكيد ✓️ تم تفعيلها \n📮¦ بواسطه ⋙「 '..NameUser..' 」 \n') end
...
local GroupUsers = tonumber(redis:get(AlBaghdadi..':addnumberusers') or 0)
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(AlBaghdadi..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(AlBaghdadi..':MONSHA_Group:'..arg.chat_id_,data.id_)
...
redis:mset(
AlBaghdadi..'group:add'..arg.chat_id_,true,
AlBaghdadi..'lock_link'..arg.chat_id_,true, 
AlBaghdadi..'lock_id'..arg.chat_id_,true,
AlBaghdadi..'lock_spam'..arg.chat_id_,true,
AlBaghdadi..'lock_webpage'..arg.chat_id_,true,
AlBaghdadi..'lock_markdown'..arg.chat_id_,true,
AlBaghdadi..'lock_flood'..arg.chat_id_,true,
AlBaghdadi..'lock_bots'..arg.chat_id_,true,
AlBaghdadi..'mute_forward'..arg.chat_id_,true,
AlBaghdadi..'mute_contact'..arg.chat_id_,true,
AlBaghdadi..'mute_location'..arg.chat_id_,true,
AlBaghdadi..'mute_document'..arg.chat_id_,true,
AlBaghdadi..'mute_keyboard'..arg.chat_id_,true,
AlBaghdadi..'mute_game'..arg.chat_id_,true,
AlBaghdadi..'mute_inline'..arg.chat_id_,true,
AlBaghdadi..'lock_username'..arg.chat_id_,true,
AlBaghdadi..'num_msg_max'..arg.chat_id_,5, 
AlBaghdadi..'lock_edit'..arg.chat_id_,true,
AlBaghdadi..'replay'..arg.chat_id_,true,
AlBaghdadi..'lock_rdodSource'..arg.chat_id_,true,
AlBaghdadi.."lock_KickBan"..msg.chat_id_,true,
AlBaghdadi.."lock_mmno3"..msg.chat_id_,true,
AlBaghdadi.."lock_KickBan"..msg.chat_id_,true,
AlBaghdadi.."lock_RandomRdod"..msg.chat_id_,true,
AlBaghdadi.."lock_linkk"..msg.chat_id_,true
)
redis:sadd(AlBaghdadi..'group:ids',arg.chat_id_) 
redis:sadd(AlBaghdadi..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(AlBaghdadi..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(AlBaghdadi..'linkGroup'..arg.chat_id_,Gp_Link)
...
redis:hset(AlBaghdadi..'username:'..UserID, 'username', Resolv)
redis:sadd(AlBaghdadi..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم تقييده بنجاح \n✓")
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(AlBaghdadi..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم فك تقييده بنجاح \n✓")
end
if cmd == "setwhitelist" then
if redis:sismember(AlBaghdadi..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مميز  في المجموعه \n✓") 
end
redis:hset(AlBaghdadi..'username:'..UserID, 'username', Resolv)
redis:sadd(AlBaghdadi..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مميز  في المجموعه \n✓") 
end
if cmd == "remwhitelist" then
if not redis:sismember(AlBaghdadi..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مميز  في المجموعه \n✓") 
end
redis:srem(AlBaghdadi..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مميز  في المجموعه \n✓") 
end
if cmd == "setmnsha" then
if redis:sismember(AlBaghdadi..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ  في المجموعه \n✓") 
end
redis:hset(AlBaghdadi..'username:'..UserID, 'username', Resolv)
redis:sadd(AlBaghdadi..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ  في المجموعه \n✓") 
end
if cmd == "remmnsha" then
if not redis:sismember(AlBaghdadi..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ  في المجموعه \n✓") 
end
redis:srem(AlBaghdadi..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشى  في المجموعه \n✓") 
end

if cmd == "setowner" then
if redis:sismember(AlBaghdadi..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مدير  في المجموعه \n✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(AlBaghdadi..'username:'..UserID, 'username', Resolv)
redis:sadd(AlBaghdadi..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مدير  في المجموعه \n✓") 
end
if cmd == "remowner" then
if not redis:sismember(AlBaghdadi..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مدير  في المجموعه \n✓") 
end
redis:srem(AlBaghdadi..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مدير  في المجموعه \n✓") 
end
if cmd == "promote" then
if redis:sismember(AlBaghdadi..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه ادمن  في المجموعه \n✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(AlBaghdadi..'username:'..UserID, 'username', Resolv)
redis:sadd(AlBaghdadi..'admins:'..ChatID,UserID) 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه ادمن  في المجموعه \n✓") 
end
if cmd == "demote" then
if not redis:sismember(AlBaghdadi..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله ادمن  في المجموعه \n✓") 
end
redis:srem(AlBaghdadi..'admins:'..ChatID,UserID)
...
if cmd == "Upmonsh" then
if redis:sismember(AlBaghdadi..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ اساسي  في المجموعه \n✓") 
end
redis:hset(AlBaghdadi..'username:'..UserID,'username',USERNAME)
redis:sadd(AlBaghdadi..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ اساسي  في المجموعه \n✓") 
end

if cmd == "Dwmonsh" then
if not redis:sismember(AlBaghdadi..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه \n✓") 
end
redis:srem(AlBaghdadi..':MONSHA_Group:'..ChatID,UserID) 
...
redis:hset(AlBaghdadi..'username:'..UserID, 'username', Resolv)
redis:sadd(AlBaghdadi..'banned:'..ChatID,UserID)
...
redis:hset(AlBaghdadi..'username:'..UserID, 'username', Resolv)
redis:srem(AlBaghdadi..'banned:'..ChatID,UserID)
StatusLeft(ChatID,UserID)
return false
end
...
redis:hset(AlBaghdadi..'username:'..UserID, 'username', Resolv)
redis:sadd(AlBaghdadi..'is_silent_users:'..ChatID,UserID)
...
redis:hset(AlBaghdadi..'username:'..UserID, 'username', Resolv)
redis:srem(AlBaghdadi..'is_silent_users:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء كتمه  من المجموعه \n✓") 
end

if cmd == "upMshrf" then
redis:hset(AlBaghdadi..'username:'..UserID,'username',Resolv)
redis:setex(AlBaghdadi..":uploadingsomeon:"..ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(AlBaghdadi..":uploadingsomeon2:"..ChatID..msg.sender_user_id_,500,UserID)
...
if cmd == "tfa3l" then  
local maseegs = redis:get(AlBaghdadi..'msgs:'..UserID..':'..ChatID) or 1
local edited = redis:get(AlBaghdadi..':edited:'..ChatID..':'..UserID) or 0
local content = redis:get(AlBaghdadi..':adduser:'..ChatID..':'..UserID) or 0
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
if UserID == 961743188 or UserID == 665877797 then return sendMsg(ChatID,MsgID,"📛*¦* لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
...
.."\n📝¦ التعديل » "..(redis:get(AlBaghdadi..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗¦ الروابط » "..(redis:get(AlBaghdadi..'lock_link'..msg.chat_id_) or 'false')
.."\n#️⃣¦ التاك » "..(redis:get(AlBaghdadi..'lock_tag'..msg.chat_id_) or 'false')
.."\n©¦ المعرفات » "..(redis:get(AlBaghdadi..'lock_username'..msg.chat_id_) or 'false')
.."\n\n💱¦ التكرار » "..(redis:get(AlBaghdadi..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑¦ الكلايش » "..(redis:get(AlBaghdadi..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐¦ الويب » "..(redis:get(AlBaghdadi..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️¦ الماركدوان » "..(redis:get(AlBaghdadi..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻¦ البوتات بالطرد » "..(redis:get(AlBaghdadi..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖¦ البوتات » "..(redis:get(AlBaghdadi..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕¦ عدد التكرار » "..(redis:get(AlBaghdadi..'num_msg_max'..msg.chat_id_) or 'false')
.."\n⏰¦ وقت التنظيف » "..(redis:get(AlBaghdadi..':Timer_Cleaner:'..msg.chat_id_) or '6').." ساعة ."
.."\n\n🎬¦` اعدادات الوسائط :`\n"
.."\n🤹*¦* المتحركه » "..(redis:get(AlBaghdadi..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭¦ الدردشه » "..(redis:get(AlBaghdadi..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️¦ الانلاين » "..(redis:get(AlBaghdadi..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮¦ الالعاب » "..(redis:get(AlBaghdadi..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞¦ الصور » "..(redis:get(AlBaghdadi..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥¦ الفيديو » "..(redis:get(AlBaghdadi..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙¦ الصوت » "..(redis:get(AlBaghdadi..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n🔉¦ البصمات » "..(redis:get(AlBaghdadi..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎¦ الملصقات » "..(redis:get(AlBaghdadi..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞¦ الجهات » "..(redis:get(AlBaghdadi..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱¦ التوجيه » "..(redis:get(AlBaghdadi..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐¦ الموقع » "..(redis:get(AlBaghdadi..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂¦ الملفات » "..(redis:get(AlBaghdadi..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅¦ الاشعارات » "..(redis:get(AlBaghdadi..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒¦ الفشار » "..(redis:get(AlBaghdadi..'lock_mmno3'..msg.chat_id_) or 'false')
.."\n🔒¦ الفارسيه » "..(redis:get(AlBaghdadi..'lock_pharsi'..msg.chat_id_) or 'false')
.."\n🔒¦ الانكليزيه » "..(redis:get(AlBaghdadi..'lock_lang'..msg.chat_id_) or 'false')
.."\n🔒¦ الاضافه » "..(redis:get(AlBaghdadi..'lock_Add'..msg.chat_id_) or 'false')

local eueuf = "\n\n*⚒¦*` اعدادات اخرى : `"
.."\n*🙋🏼‍♂️¦* الترحيب » "..(redis:get(AlBaghdadi..'welcome:get'..msg.chat_id_) or 'false')
.."\n*📋¦*  الردود » "..(redis:get(AlBaghdadi..'replay'..msg.chat_id_) or 'false')
.."\n*📋¦*  الردود العشوائيه » "..(redis:get(AlBaghdadi.."lock_RandomRdod"..msg.chat_id_) or 'false')
.."\n*🚸¦*  التحذير » "..(redis:get(AlBaghdadi..'lock_woring'..msg.chat_id_) or 'false')
.."\n*📝¦* الايدي » "..(redis:get(AlBaghdadi..'lock_id'..msg.chat_id_) or 'false')
.."\n*💬¦* الرابط » "..(redis:get(AlBaghdadi..'lock_linkk'..msg.chat_id_) or 'false')
.."\n*📮¦* المغادره » "..(redis:get(AlBaghdadi..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n*🗳¦* الحظر » "..(redis:get(AlBaghdadi..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n*🔍¦* الحمايه » "..(redis:get(AlBaghdadi..'antiedit'..msg.chat_id_) or 'false')
.."\n*📋¦* التاك للكل » "..(redis:get(AlBaghdadi..'lock_takkl'..msg.chat_id_) or 'false')
.."\n*📒¦* الايدي بالصوره » "..(redis:get(AlBaghdadi..'idphoto'..msg.chat_id_) or 'false')
.."\n*🔐¦* التحقق » "..(redis:get(AlBaghdadi.."lock_check"..msg.chat_id_) or 'false')
.."\n*🗑¦* التنظيف التلقائي » "..(redis:get(AlBaghdadi.."lock_cleaner"..msg.chat_id_) or 'false')
.."\n*📂¦* ردود السورس » "..(redis:get(AlBaghdadi.."lock_rdodSource"..msg.chat_id_) or 'false')
...
.."\n*➕¦* عدد التكرار » "..(redis:get(AlBaghdadi..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n*💱¦*` اعدادات التقـييد :`\n"
.."\n*💢¦* التقييد بالتوجيه » "..(redis:get(AlBaghdadi..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸¦* التقييد بالصور » "..(redis:get(AlBaghdadi..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗¦* التقييد بالروابط » "..(redis:get(AlBaghdadi..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉¦* التقييد بالمتحركه » "..(redis:get(AlBaghdadi..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥¦* التقييد الفيديو » "..(redis:get(AlBaghdadi..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
...
.."\n*🗂¦* الملفات » "..(redis:get(AlBaghdadi..'mute_document'..msg.chat_id_) or 'false')
.."\n*🔅¦* الاشعارات » "..(redis:get(AlBaghdadi..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n*🔒¦* الكيبورد » "..(redis:get(AlBaghdadi..'mute_keyboard'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
return sendMsg(msg.chat_id_,msg.id_,'➖\n'..list_settings..'\n')
end
