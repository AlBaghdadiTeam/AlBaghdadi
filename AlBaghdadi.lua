...
local hash = database:sismember(bot_id.."FCFFFF:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) then     
return true    
else    
return false    
...
var = true  
elseif tonumber(user_id) == tonumber(961743188) then
var = true 
...
var = true
elseif database:sismember(bot_id..'FCFFFF:MN:TF'..chat_id, user_id) then
var = true  
...
send(msg.chat_id_, msg.id_,' ● اصدار سورس البغدادي\n ● الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت •' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ● [تحديثات البوت](t.me/ALSH_3K) \n ● [قناه السورس](t.me/ALSH_3K)')
end
...
usertext = '\n ● العضو » ['..result.title_..'](t.me/'..(username or 'ALSH_3K')..')'
status  = '\n ● تم ترقيته مطور'
...
usertext = '\n ● العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ALSH_3K')..')'
status  = '\n ● تم ترقيته مطور'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ● العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ALSH_3K')..') \n ● '..AlBaghdadi1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ● العضو : {["..data.first_name_.."](T.ME/ALSH_3K)}\n ● ["..AlBaghdadi_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ● عذرا » {["..data.first_name_.."](T.ME/ALSH_3K)}\n ● عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ● بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ALSH_3K')..') \n ● تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ● بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ALSH_3K')..') \n ● تـم قفـل التاك بالكتم ')
end,nil)   
...
if database:get(bot_id.."FCFFFF:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'FCFFFF:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if database:get(bot_id.."FCFFFF:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'FCFFFF:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
local UserName = (b.username_ or "ALSH_3K")
...
database:del(bot_id..'FCFFFF:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ● تم مسح المنظفيه')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'FCFFFF:MN:TF'..msg.chat_id_)
t = "\n ● قائمة المنظفين \n●○●○●○●○●○●○\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'FCFFFF:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ● العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ALSH_3K')..')'
status  = '\n ● تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'FCFFFF:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ● العضو » ['..result.title_..'](t.me/'..(username or 'ALSH_3K')..')'
status  = '\n ● تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'FCFFFF:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ● العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ALSH_3K')..')'
status  = '\n ● تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'FCFFFF:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ● العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ALSH_3K')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'FCFFFF:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ● العضو » ['..result.title_..'](t.me/'..(username or 'ALSH_3K')..')'
status  = '\n ● تم تنزيله من المنظفيه'
texts = usertext..status
else
...
database:srem(bot_id..'FCFFFF:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ● العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ALSH_3K')..')'
status  = '\n ● تم تنزيله من المنظفيه'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ● لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ALSH_3K')..')'
status  = '\n ● تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ● العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ● العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ALSH_3K')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ● العضو » ['..result.title_..'](t.me/'..(text1[3] or 'ALSH_3K')..')'..'\n ● تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:sadd(bot_id.."FCFFFF:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."FCFFFF:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "● تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."FCFFFF:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."FCFFFF:allM"..msg.chat_id_)
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'البغدادي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'البغدادي')
local AlBaghdadi_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'البغدادي').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ALSH_3K')..')'
local iduser = result.sender_user_id_
...
● ردود المطور 
    ●○●○●○●○●○●○ 
[AlBaghdadi 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me